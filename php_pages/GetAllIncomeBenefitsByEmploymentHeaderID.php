...
$app_info1 = file_get_contents('http://52.16.72.176/ffAPI/api/Get/GetAllIncomeBenefitsByEmploymentHeaderID?EmploymentHeaderID='.$EmploymentHeaderID.'');
...
//$result = "{\"XmlTagName\":\"FactFinds\",\"ModifiedBy\":68,\"ModifiedByForDatabase\":68,\"FFID\":4204,\"UserID\":68,\"StaffID\":null,\"eCaseStatusID\":1,\"ProcessingStatusID\":null,\"Modified_By\":68,\"ObjectState\":1}1";

$sValidJson = preg_replace("/(\n[\t ]*)([^\t ]+):/", "$1\"$2\":", $app_info1);

$tt = urldecode(str_replace("\\","",$sValidJson));

$string = substr($tt, 1, -1);
